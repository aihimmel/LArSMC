...
void MakePCRGraphPDFs(std::string ginfile_name, std::string goutfile_pdf_name1, std::string goutfile_pdf_name2, std::string goutfile_pdf_name3)
{
    ...
    g1->GetYaxis()->SetRangeUser(0.0, 110000.0);
    g1->Draw();
    c1->Update();
...
void MakePDFs_150nm()
{
    std::string ginfile_name = "/nashome/a/abreaux/Downloads/larsmc_150nm/gPhotonCount_vs_r2_150nm.root";
    std::string hinfile_name = "/nashome/a/abreaux/Downloads/larsmc_150nm/PhotonCount_vs_r2_150nm.root";
    std::string finfile_name = "/nashome/a/abreaux/Downloads/larsmc_150nm/AttenuationLength_Vs_HLArMin_150nm.root";
    std::string goutfile_pdf_name1 = "/nashome/a/abreaux/Downloads/larsmc_150nm/g1PCvsR2_150nm.pdf";
    std::string goutfile_pdf_name2 = "/nashome/a/abreaux/Downloads/larsmc_150nm/g2PCvsR2_150nm.pdf";
    std::string goutfile_pdf_name3 = "/nashome/a/abreaux/Downloads/larsmc_150nm/g3PCvsR2_150nm.pdf";
    std::string houtfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_150nm/hPCvsR2_150nm.pdf";
    std::string foutfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_150nm/fALvsMHLAr_150nm.pdf";
