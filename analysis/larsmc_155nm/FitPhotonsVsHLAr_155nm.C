...
void GraphAttLensVsHLArMin(double attenuation_length_0to3mm, std::vector<double> attenuation_lengths_15to18mm, std::vector<double> attenuation_lengths_30to33mm, std::vector<double> attenuation_lengths_42to45mm, std::vector<double> attenuation_lengths_45to48mm, std::vector<double> attenuation_lengths_48to51mm)
{
    ...
    g1->GetYaxis()->SetRangeUser(85.0, 2000.0);
    g1->Draw("AP");
    ...
    legend->Draw();
    cmain->Update();
    cmain->Print("/nashome/a/abreaux/Downloads/larsmc_155nm/AttenuationLength_Vs_HLArMin_155nm.root");
}
...
double Fit_0to3mm(std::string ginput_name, std::string r_range_name)
{
    ...
    canvas->Print("/nashome/a/abreaux/Downloads/larsmc_155nm/FitALvsSL_0to3mm.root");
...
std::vector<double> Fit_Other(std::string ginput_name, std::string r_range_name)
{
    ...
    for (int i = 0; i < 12; i++)
    {
        ...
        f1->Draw("SAME");
        std::string outfile_name = "/nashome/a/abreaux/Downloads/larsmc_155nm/FitALvsSL_" + r_range_name + HLAr_mins_names[i] + ".root";
...
void FitPhotonsVsHLAr_155nm()
{
    ...
    for (int i = 0; i < 19; i++)
    {
        std::string ginput_name = "/nashome/a/abreaux/Downloads/larsmc_155nm/gPhotonCount_vs_r2_" + r_range_names[i] + "_155nm.root";
