#define Track_h50d97cm_155nm_cxx
#include "Track_h50d97cm_155nm.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Track_h50d97cm_155nm::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Track_h50d97cm_155nm.C
//      root> Track_h50d97cm_155nm t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h1->Draw();
   std::string OutfilePath = "/nashome/a/abreaux/Downloads/larsmc_155nm/PhotonCount_vs_r2_50d97_155nm.root";
   canvas->Update();
