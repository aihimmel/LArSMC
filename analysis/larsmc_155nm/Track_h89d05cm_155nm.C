#define Track_h89d05cm_155nm_cxx
#include "Track_h89d05cm_155nm.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Track_h89d05cm_155nm::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Track_h89d05cm_155nm.C
//      root> Track_h89d05cm_155nm t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h1->Draw();
   std::string OutfilePath = "/nashome/a/abreaux/Downloads/larsmc_155nm/PhotonCount_vs_r2_89d05_155nm.root";
   canvas->Update();
