#define Track_h76d33cm_115nm_cxx
#include "Track_h76d33cm_115nm.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Track_h76d33cm_115nm::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Track_h76d33cm_115nm.C
//      root> Track_h76d33cm_115nm t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h1->Draw();
   std::string OutfilePath = "/nashome/a/abreaux/Downloads/larsmc_115nm/PhotonCount_vs_r2_76d33_115nm.root";
   canvas->Update();
