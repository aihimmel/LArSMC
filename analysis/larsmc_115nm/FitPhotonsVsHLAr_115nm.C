...
void GraphAttLensVsHLArMin(double attenuation_length_0to3mm, std::vector<double> attenuation_lengths_15to18mm, std::vector<double> attenuation_lengths_30to33mm, std::vector<double> attenuation_lengths_42to45mm, std::vector<double> attenuation_lengths_45to48mm, std::vector<double> attenuation_lengths_48to51mm)
{
    ...
    g1->GetYaxis()->SetRangeUser(52.0, 175.0);
    g1->Draw("AP");
    ...
    TLine *l1 = new TLine(0, 56.84, 105, 56.84);
    ...
    legend->Draw();
    cmain->Update();
    cmain->Print("/nashome/a/abreaux/Downloads/larsmc_115nm/AttenuationLength_Vs_HLArMin_115nm.root");
}
...
void FitPhotonsVsHLAr_115nm()
{
    ...
    for (int i = 0; i < 19; i++)
    {
        std::string ginput_name = "/nashome/a/abreaux/Downloads/larsmc_115nm/gPhotonCount_vs_r2_" + r_range_names[i] + "_115nm.root";
