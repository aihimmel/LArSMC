...
void MakePCRGraphPDFs(std::string ginfile_name, std::string goutfile_pdf_name1, std::string goutfile_pdf_name2, std::string goutfile_pdf_name3)
{
    ...
    g1->GetYaxis()->SetRangeUser(0.0, 300000.0);
    g1->Draw();
    c1->Update();
...
void MakePDFs_115nm()
{
    std::string ginfile_name = "/nashome/a/abreaux/Downloads/larsmc_115nm/gPhotonCount_vs_r2_115nm.root";
    std::string hinfile_name = "/nashome/a/abreaux/Downloads/larsmc_115nm/PhotonCount_vs_r2_115nm.root";
    std::string finfile_name = "/nashome/a/abreaux/Downloads/larsmc_115nm/AttenuationLength_Vs_HLArMin_115nm.root";
    std::string goutfile_pdf_name1 = "/nashome/a/abreaux/Downloads/larsmc_115nm/g1PCvsR2_115nm.pdf";
    std::string goutfile_pdf_name2 = "/nashome/a/abreaux/Downloads/larsmc_115nm/g2PCvsR2_115nm.pdf";
    std::string goutfile_pdf_name3 = "/nashome/a/abreaux/Downloads/larsmc_115nm/g3PCvsR2_115nm.pdf";
    std::string houtfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_115nm/hPCvsR2_115nm.pdf";
    std::string foutfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_115nm/fALvsMHLAr_115nm.pdf";
