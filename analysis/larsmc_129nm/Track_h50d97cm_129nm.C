#define Track_h50d97cm_129nm_cxx
#include "Track_h50d97cm_129nm.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Track_h50d97cm_129nm::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Track_h50d97cm_129nm.C
//      root> Track_h50d97cm_129nm t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h1->Draw();
   std::string OutfilePath = "/nashome/a/abreaux/Downloads/larsmc_129nm/PhotonCount_vs_r2_50d97_129nm.root";
   canvas->Update();
