...
void MakePCRGraphPDFs(std::string ginfile_name, std::string goutfile_pdf_name1, std::string goutfile_pdf_name2, std::string goutfile_pdf_name3)
{
    ...
    // g1->GetYaxis()->SetRangeUser(0.0, 200000.0);
    // g1->Draw();
    // c1->Update();
...
void MakePDFs_129nm()
{
    std::string ginfile_name = "/nashome/a/abreaux/Downloads/larsmc_129nm/gPhotonCount_vs_r2_129nm.root";
    std::string hinfile_name = "/nashome/a/abreaux/Downloads/larsmc_129nm/PhotonCount_vs_r2_129nm.root";
    std::string finfile_name = "/nashome/a/abreaux/Downloads/larsmc_129nm/AttenuationLength_Vs_HLArMin_129nm.root";
    std::string goutfile_pdf_name1 = "/nashome/a/abreaux/Downloads/larsmc_129nm/g1PCvsR2_129nm.pdf";
    std::string goutfile_pdf_name2 = "/nashome/a/abreaux/Downloads/larsmc_129nm/g2PCvsR2_129nm.pdf";
    std::string goutfile_pdf_name3 = "/nashome/a/abreaux/Downloads/larsmc_129nm/g3PCvsR2_129nm.pdf";
    std::string houtfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_129nm/hPCvsR2_129nm.pdf";
    std::string foutfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_129nm/fALvsMHLAr_129nm.pdf";
