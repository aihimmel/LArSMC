#define Track_h5d23cm_180nm_ref_cxx
#include "Track_h5d23cm_180nm_ref.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Track_h5d23cm_180nm_ref::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Track_h5d23cm_180nm_ref.C
//      root> Track_h5d23cm_180nm_ref t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h1->Draw();
   std::string OutfilePath = "/nashome/a/abreaux/Downloads/larsmc_180nm_ref/PhotonCount_vs_r2_5d23_180nm_ref.root";
   canvas->Update();
