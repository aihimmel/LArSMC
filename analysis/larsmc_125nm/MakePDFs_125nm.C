...
void MakePDFs_125nm()
{
    std::string ginfile_name = "/nashome/a/abreaux/Downloads/larsmc_125nm/gPhotonCount_vs_r2_125nm.root";
    std::string hinfile_name = "/nashome/a/abreaux/Downloads/larsmc_125nm/PhotonCount_vs_r2_125nm.root";
    std::string finfile_name = "/nashome/a/abreaux/Downloads/larsmc_125nm/AttenuationLength_Vs_HLArMin_125nm.root";
    std::string goutfile_pdf_name1 = "/nashome/a/abreaux/Downloads/larsmc_125nm/g1PCvsR2_125nm.pdf";
    std::string goutfile_pdf_name2 = "/nashome/a/abreaux/Downloads/larsmc_125nm/g2PCvsR2_125nm.pdf";
    std::string goutfile_pdf_name3 = "/nashome/a/abreaux/Downloads/larsmc_125nm/g3PCvsR2_125nm.pdf";
    std::string houtfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_125nm/hPCvsR2_125nm.pdf";
    std::string foutfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_125nm/fALvsMHLAr_125nm.pdf";
