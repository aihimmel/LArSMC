...
void GraphAttLensVsHLArMin(double attenuation_length_0to3mm, std::vector<double> attenuation_lengths_15to18mm, std::vector<double> attenuation_lengths_30to33mm, std::vector<double> attenuation_lengths_42to45mm, std::vector<double> attenuation_lengths_45to48mm, std::vector<double> attenuation_lengths_48to51mm)
{
    ...
    g1->GetYaxis()->SetRangeUser(102.5, 670.0);
    g1->Draw("AP");
    ...
    TLine *l1 = new TLine(0, 107.949, 105, 107.949);
    ...
    legend->Draw();
    cmain->Update();
    cmain->Print("/nashome/a/abreaux/Downloads/larsmc_135nm/AttenuationLength_Vs_HLArMin_135nm.root");
}
...
void FitPhotonsVsHLAr_135nm()
{
    ...
    for (int i = 0; i < 19; i++)
    {
        std::string ginput_name = "/nashome/a/abreaux/Downloads/larsmc_135nm/gPhotonCount_vs_r2_" + r_range_names[i] + "_135nm.root";
