...
void MakePCRGraphPDFs(std::string ginfile_name, std::string goutfile_pdf_name1, std::string goutfile_pdf_name2, std::string goutfile_pdf_name3)
{
    ...
    g1->GetYaxis()->SetRangeUser(0.0, 150000.0);
    g1->Draw();
    c1->Update();
...
void MakePDFs_135nm()
{
    std::string ginfile_name = "/nashome/a/abreaux/Downloads/larsmc_135nm/gPhotonCount_vs_r2_135nm.root";
    std::string hinfile_name = "/nashome/a/abreaux/Downloads/larsmc_135nm/PhotonCount_vs_r2_135nm.root";
    std::string finfile_name = "/nashome/a/abreaux/Downloads/larsmc_135nm/AttenuationLength_Vs_HLArMin_135nm.root";
    std::string goutfile_pdf_name1 = "/nashome/a/abreaux/Downloads/larsmc_135nm/g1PCvsR2_135nm.pdf";
    std::string goutfile_pdf_name2 = "/nashome/a/abreaux/Downloads/larsmc_135nm/g2PCvsR2_135nm.pdf";
    std::string goutfile_pdf_name3 = "/nashome/a/abreaux/Downloads/larsmc_135nm/g3PCvsR2_135nm.pdf";
    std::string houtfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_135nm/hPCvsR2_135nm.pdf";
    std::string foutfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_135nm/fALvsMHLAr_135nm.pdf";
