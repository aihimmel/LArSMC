...
void MakePDFs()
{
    std::string norm_infile_name = "/nashome/a/abreaux/Downloads/ScatLens_Vs_AttLens.root";
    std::string fit_infile_name = "/nashome/a/abreaux/Downloads/FitScatLens_Vs_AttLens.root";
    std::string correction_infile_name = "/nashome/a/abreaux/Downloads/CorrectionScatLens_Vs_AttLens_";
    
    std::string norm_outfile_pdf_name = "/nashome/a/abreaux/Downloads/SLvsAL.pdf";
    std::string fit_outfile_pdf_name = "/nashome/a/abreaux/Downloads/FitSLvsAL.pdf";
    std::string correction_outfile_pdf_name = "/nashome/a/abreaux/Downloads/CorrectSLvsAL_";
