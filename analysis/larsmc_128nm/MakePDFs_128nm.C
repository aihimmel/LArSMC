...
void MakePDFs_128nm()
{
    std::string ginfile_name = "/nashome/a/abreaux/Downloads/larsmc_128nm/gPhotonCount_vs_r2_128nm.root";
    std::string hinfile_name = "/nashome/a/abreaux/Downloads/larsmc_128nm/PhotonCount_vs_r2_128nm.root";
    std::string finfile_name = "/nashome/a/abreaux/Downloads/larsmc_128nm/AttenuationLength_Vs_HLArMin_128nm.root";
    std::string goutfile_pdf_name1 = "/nashome/a/abreaux/Downloads/larsmc_128nm/g1PCvsR2_128nm.pdf";
    std::string goutfile_pdf_name2 = "/nashome/a/abreaux/Downloads/larsmc_128nm/g2PCvsR2_128nm.pdf";
    std::string goutfile_pdf_name3 = "/nashome/a/abreaux/Downloads/larsmc_128nm/g3PCvsR2_128nm.pdf";
    std::string houtfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_128nm/hPCvsR2_128nm.pdf";
    std::string foutfile_pdf_name = "/nashome/a/abreaux/Downloads/larsmc_128nm/fALvsMHLAr_128nm.pdf";
