#define Track_h2d22cm_128nm_cxx
#include "Track_h2d22cm_128nm.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Track_h2d22cm_128nm::Loop()
{
//   In a ROOT session, you can do:
//      root> .L Track_h2d22cm_128nm.C
//      root> Track_h2d22cm_128nm t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h1->Draw();
   std::string OutfilePath = "/nashome/a/abreaux/Downloads/larsmc_128nm/PhotonCount_vs_r2_2d22_128nm.root";
   canvas->Update();
